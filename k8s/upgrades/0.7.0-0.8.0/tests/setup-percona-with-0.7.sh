...
echo "Launching percona with jiva"
...
echo "Launching percona with cstor"
kubectl apply -f https://raw.githubusercontent.com/openebs/openebs/master/k8s/demo/percona/percona-openebs-cstor-sparse-deployment.yaml
