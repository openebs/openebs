...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `1.2.0-RC2`                                   |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `1.2.0-RC2`                                   |
| `provisioner.replicas`                  | Number of Provisioner Replicas                | `1`                                       |
| `localProvisioner.image`                | Image for localProvisioner                    | `quay.io/openebs/provisioner-localpv`     |
| `localProvisioner.imageTag`             | Image Tag for localProvisioner                | `1.2.0-RC2`                                   |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `1.2.0-RC2`                                   |
...
| `snapshotOperator.controller.imageTag`  | Image Tag for Snapshot Controller             | `1.2.0-RC2`                                   |
| `snapshotOperator.replicas`             | Number of Snapshot Operator Replicas          | `1`                                       |
| `ndm.image`                             | Image for Node Disk Manager                   | `quay.io/openebs/node-disk-manager-amd64` |
| `ndm.imageTag`                          | Image Tag for Node Disk Manager               | `v0.4.2-RC2`                              |
...
| `ndmOperator.imageTag`                  | Image Tag for NDM Operator                    | `v0.4.2-RC2`                              |
| `jiva.image`                            | Image for Jiva                                | `quay.io/openebs/jiva`                    |
| `jiva.imageTag`                         | Image Tag for Jiva                            | `1.2.0-RC2`                                   |
...
| `cstor.pool.imageTag`                   | Image Tag for cStor Pool                      | `1.2.0-RC2`                                   |
| `cstor.poolMgmt.image`                  | Image for cStor Pool  Management              | `quay.io/openebs/cstor-pool-mgmt`         |
| `cstor.poolMgmt.imageTag`               | Image Tag for cStor Pool Management           | `1.2.0-RC2`                                   |
| `cstor.target.image`                    | Image for cStor Target                        | `quay.io/openebs/cstor-istgt`             |
| `cstor.target.imageTag`                 | Image Tag for cStor Target                    | `1.2.0-RC2`                                   |
| `cstor.volumeMgmt.image`                | Image for cStor Volume  Management            | `quay.io/openebs/cstor-volume-mgmt`       |
| `cstor.volumeMgmt.imageTag`             | Image Tag for cStor Volume Management         | `1.2.0-RC2`                                   |
| `policies.monitoring.image`             | Image for Prometheus Exporter                 | `quay.io/openebs/m-exporter`              |
| `policies.monitoring.imageTag`          | Image Tag for Prometheus Exporter             | `1.2.0-RC2`                                   |
