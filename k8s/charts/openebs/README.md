...
| `apiserver.imageTag`                    | Image Tag for API Server                      | `1.0.0-RC3`                                   |
...
| `provisioner.imageTag`                  | Image Tag for Provisioner                     | `1.0.0-RC3`                                   |
| `provisioner.replicas`                  | Number of Provisioner Replicas                | `1`                                       |
| `localProvisioner.image`                | Image for localProvisioner                    | `quay.io/openebs/provisioner-localpv`     |
| `localProvisioner.imageTag`             | Image Tag for localProvisioner                | `1.0.0-RC3`                                   |
...
| `webhook.imageTag`                      | Image Tag for admission server                | `1.0.0-RC3`                                   |
...
| `snapshotOperator.provisioner.imageTag` | Image Tag for Snapshot Provisioner            | `1.0.0-RC3`                                   |
| `snapshotOperator.controller.image`     | Image for Snapshot Controller                 | `quay.io/openebs/snapshot-controller`     |
| `snapshotOperator.controller.imageTag`  | Image Tag for Snapshot Controller             | `1.0.0-RC3`                                   |
| `snapshotOperator.replicas`             | Number of Snapshot Operator Replicas          | `1`                                       |
| `ndm.image`                             | Image for Node Disk Manager                   | `quay.io/openebs/node-disk-manager-amd64` |
| `ndm.imageTag`                          | Image Tag for Node Disk Manager               | `v0.4.0-RC3`                              |
