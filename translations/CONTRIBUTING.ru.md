...
- [Как внести свой вклад в OpenEBS](#как-внести-свой-вклад-в-openebs)
  - [Открытие issue](#открытие-issue)
  - [Улучшение документации](#улучшение-документации)
  - [Предложения нового функционала](#предложения-нового-функционала)
  - [Контрибьюшен в исходный код и фикс багов](#контрибьюшен-в-исходный-код-и-фикс-багов)
  - [Решение существующих задач](#решение-существующих-задач)
    - [Подпишите свою работу](#подпишите-свою-работу)
  - [Присоединяйтесь к коммьюнити!](#присоединяйтесь-к-коммьюнити)
...
* Для контрибьюта в K8s demo, просмотрите этот [документ](./contribute/CONTRIBUTING-TO-K8S-DEMO.md).
	- Для информации как OpenEBS работает с K8s, просмотрите этот [документ](https://openebs.io/docs) 
